...
// Your code here:
for (const banana in user) {
  console.log(`${banana} : ${user[banana]}`);
}
// Name doesn't matter - loop iterates trow all keys in object
...
// Your code here:
const obj = {}; // Here it is like dictionary in C#
const noDub = [];
...
console.log(`Array without dublicates: ${noDub}`);
...
//repeat works only with strings
