...
function LoginPage() {
  ...
  return (
    <div style={{ padding: '2rem', width: '100%', maxWidth: 400, marginInline: 'auto' }}>
      <h1>Login</h1>
      <form onSubmit={handleSubmit} style={{ display: 'block' }}>
        <fieldset style={{ display: 'block', width: '100%', boxSizing: 'border-box' }}>
          <legend>Put your creds</legend>
          <input
            value={userName}
            name="userName"
            autoComplete="false"
